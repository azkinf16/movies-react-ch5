  ...
  return (
    <div className="flex items-center justify-between py-5 px-10 z-10 absolute w-full">
      <img
        ...
        alt="logo"
      />
      <div className="bg-transparent border-solid border-2 border-slate-500 rounded-full hover:border-red-400 hover:ring-1 flex items-center px-2 w-[200px] sm:w-[400px] lg:w-[500px]">
        <input
          className="bg-transparent p-2 w-full focus:outline-none placeholder:text-slate-500"
          type="text"
